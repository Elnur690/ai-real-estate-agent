...
class Match(Base):
    ...
    listing = relationship("Listing", back_populates="matches", lazy="noload")
    saved_search = relationship("SavedSearch", back_populates="matches", lazy="noload")
    tenant = relationship("Tenant", back_populates="matches", lazy="noload")
