...
async def lifespan(app: FastAPI):
    ...
    async with async_engine.begin() as conn:
        ...
        await conn.execute(text("ALTER TABLE sellers ADD COLUMN IF NOT EXISTS rank VARCHAR(50) DEFAULT 'Bronze';"))
        await conn.execute(text("ALTER TABLE sellers ADD COLUMN IF NOT EXISTS is_manual_rank BOOLEAN DEFAULT FALSE;"))
        ...
        await conn.execute(text("ALTER TABLE tenants ADD COLUMN IF NOT EXISTS approved_phone_numbers JSON;"))
        ...
        await conn.execute(text("ALTER TABLE plans ADD COLUMN IF NOT EXISTS addon_image_tiers JSON DEFAULT '[]'::json;"))
        ...
        await conn.execute(text("ALTER TABLE seller_packages ADD COLUMN IF NOT EXISTS feature_watermark_free_images BOOLEAN DEFAULT FALSE;"))
        await conn.execute(text("ALTER TABLE seller_packages ADD COLUMN IF NOT EXISTS included_image_requests INTEGER DEFAULT 0;"))
        await conn.execute(text("ALTER TABLE seller_packages ADD COLUMN IF NOT EXISTS addon_image_requests_price FLOAT DEFAULT 10.0;"))
        await conn.execute(text("ALTER TABLE seller_packages ADD COLUMN IF NOT EXISTS addon_image_tiers JSON DEFAULT '[]'::json;"))
        ...
        await conn.execute(text("ALTER TABLE sellers ADD COLUMN IF NOT EXISTS free_trial_feature_watermark_images BOOLEAN DEFAULT FALSE;"))
        await conn.execute(text("ALTER TABLE sellers ADD COLUMN IF NOT EXISTS free_trial_image_requests INTEGER DEFAULT 5;"))
