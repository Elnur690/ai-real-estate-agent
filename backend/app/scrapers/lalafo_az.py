...
class LalafoAzScraper(BaseScraper):
    ...
    async def fetch_item_details(item_id_or_url: str) -> dict:
        ...
        try:
            res_text, res_status = await fetch_stealth_page(api_url, headers=headers, timeout=8.0, referer="https://lalafo.az/")
        ...
        try:
            ...
            for target_url in target_urls:
                try:
                    ...
                    res_text, res_status = await fetch_stealth_page(target_url, headers=headers, timeout=10.0, referer="https://lalafo.az/")
                    if res_status == 200 and res_text:
