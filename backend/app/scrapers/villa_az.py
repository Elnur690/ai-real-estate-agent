...
class VillaAzScraper(BaseScraper):
    ...
    async def scrape_source(self, url_or_handle: str = "https://villa.az/api/listings") -> List[RawListingItem]:
        ...
        try:
            ...
            res_text, res_status = await fetch_stealth_page(self.API_URL, headers=headers, timeout=10.0, referer="https://villa.az/")
        ...
        try:
            ...
            res_text, res_status = await fetch_stealth_page(self.BASE_URL, headers=headers, timeout=10.0, referer="https://villa.az/")
            if res_status == 200 and res_text:
