...
from app.scrapers.utils import get_random_headers, safe_float, fetch_stealth_page, polite_delay
        ...
        try:
            ...
            for target_url in target_urls:
                try:
                    ...
                    res_text, res_status = await fetch_stealth_page(target_url, headers=headers, timeout=10.0, referer="https://homdom.az/")
