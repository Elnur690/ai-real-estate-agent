    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {taskTypes.map((task) => {
          ...
          return (
            <div key={task.key} className="glass-card p-5 rounded-2xl border border-slate-800 space-y-4 flex flex-col justify-between">
              ...
              <div className="pt-2 flex items-center justify-between gap-2 border-t border-slate-800">
                ...
                <button
                  type="button"
                  onClick={() => handleSaveConfig(task.key, selectedProvider, selectedModel, apiKeyInput)}
