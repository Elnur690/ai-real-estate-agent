  ...
  const handleRegisterAgent = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.post('/sellers/me/agents', {
        ...
        telegram_chat_id: agentTg?.replace('@', '') || undefined,
  ...
  const handleSaveAgentEdit = async (e: React.FormEvent) => {
    ...
    try {
      await api.put(`/sellers/me/agents/${selectedAgent.id}`, {
        ...
        telegram_chat_id: editAgentTg?.replace('@', '') || undefined,
          ...
          <div className="bg-slate-900 border border-slate-800 w-full max-w-2xl rounded-3xl p-6 shadow-2xl space-y-5 max-h-[92vh] overflow-y-auto">
            ...
            {agentModalTab === 'edit' && (
              <form onSubmit={handleSaveAgentEdit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-semibold text-slate-300 mb-1">Hesab Statusu</label>
                    <select
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-2">
                    <label className={`flex items-center gap-2.5 p-2.5 rounded-xl border cursor-pointer transition ${
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-slate-400">Bildirişlər</div>
                      </div>
                    </label>
